  ...
  return (
    ...
    >
      <NavigationMenu.Viewport
        ...
        className={cn(
          'origin-top-center bg-popover text-popover-foreground data-[open]:animate-in data-[closed]:animate-out data-[closed]:zoom-out-95 data-[open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border shadow md:w-[var(--radix-navigation-menu-viewport-width)]',
          className,
        )}
        {...props}
      />
...
export {
  NavigationMenuWrapper as NavigationMenu,
  NavigationMenuList,
  NavigationMenuItem,
